...
public abstract class ColorValuesCollection<T extends ColorValues> implements Parcelable
{
    ...
    public static final boolean SUPPORT_LEGACY_VALUES = true;   // legacy values use a different key format (omits "_")
    ...
    {
        String prefix = getCollectionSharedPrefsPrefix() + colorsID + (SUPPORT_LEGACY_VALUES ? "" : "_");
