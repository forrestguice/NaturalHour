...
public class ColorValuesCollectionPreference extends Preference
{
    ...
    protected void updateSummary(Context context)
    {
        ...
        if (summaryStringResID != 0) {
            setSummary(context.getString(summaryStringResID, (selectedColorsLabel != null ? selectedColorsLabel : context.getString(R.string.defaultColors_name))));
        } else {
            setSummary((selectedColorsLabel != null ? selectedColorsLabel : context.getString(R.string.defaultColors_name)));
        }
    }
